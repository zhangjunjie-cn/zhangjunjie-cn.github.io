...
import wavestools from "./wavestools.vue";
import ArticleList from "./WavesArticleList.vue";
import AuthorCard from "./WavesAuthorCard.vue";
import Concentration from "./WavesConcentration.vue";
import FriendlyLink from "./FriendlyLink.vue";
import { useData } from "vitepress";
import { useTypewriter } from "../composables/waveDescriprion";
import { ref } from "vue";
import type { ArticleItem, AutherInfo, FriendItem } from "../composables/waveArticleType";
