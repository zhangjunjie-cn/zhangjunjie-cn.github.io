import{_ as D}from"./chunks/theme.7aP_7KBj.js";import{_ as A}from"./chunks/ArticleMetadata.C62JAy5x.js";import{f as b,P as s,z as h,A as M,B as l,b as n,G as e,am as f,Q as a,O as k,S as j}from"./chunks/framework.62HJNKli.js";import"./chunks/index.O69d1Uq7.js";import"./chunks/dayjs.min.CvfJgQg1.js";const v=JSON.parse('{"title":"文档书写规范","description":"使用单独的 YAML 代码块作为 frontmatter\\n","frontmatter":{"pageClass":"all-features-page","date":"2025/01/15","title":"文档书写规范","aside":"left","tags":["文档"],"categories":null,"description":"使用单独的 YAML 代码块作为 frontmatter\\n"},"headers":[],"relativePath":"features/test.md","filePath":"features/test.md","lastUpdated":1749722653000}'),N={name:"features/test.md"},E=Object.assign(N,{setup(x){return b({data:{text:"ECMAScript 语法约定"},children:[{data:{text:"数据类型 & 变量",note:"数据类型 & 变量声明 & 解构赋值 & var 变量提升 & 变量作用域 & 闭包 & 字符串运算符"}},{data:{text:"流程控制",note:"分支语句 & 循环语句 & 跳转语句"}},{data:{text:"函数",note:"声明函数 & 调用函数 & 参数 & 返回值 & 箭头函数 & 默认参数 & 函数表达式 & 函数递归 & 作用域 & 作用域链 & 立即执行函数"}},{data:{text:"面向对象",note:"声明类 & 构造器 & 实例化 & 继承 & 访问器 & 静态方法"}},{data:{text:"模块",note:"模块导入(导出) & Promise 对象 & async/await & Reflect 对象 & Set 对象 & Map 对象 & Weakset 对象 & Weakmap 对象 & Symbol 对象"}}]}),(r,t)=>{const m=A,i=s("ClientOnly"),g=s("NolebasePageProperties"),o=s("LiteTree"),u=D,c=s("NolebaseGitContributors"),I=s("NolebaseGitChangelog");return M(),h("div",null,[t[3]||(t[3]=l("h1",{id:"代码块形式的-frontmatter",tabindex:"-1"},[n("代码块形式的 frontmatter "),l("a",{class:"header-anchor",href:"#代码块形式的-frontmatter","aria-label":'Permalink to "代码块形式的 frontmatter"'},"​")],-1)),t[4]||(t[4]=n()),e(i,null,{default:a(()=>{var p,d;return[(((p=r.$frontmatter)==null?void 0:p.aside)??!0)&&(((d=r.$frontmatter)==null?void 0:d.showArticleMetadata)??!0)?(M(),k(m,{key:0,article:r.$frontmatter},null,8,["article"])):j("",!0)]}),_:1}),e(g),e(i,null,{default:a(()=>[e(o,null,{default:a(()=>t[0]||(t[0]=[n(`
	// 定义样式变量
	...
	项目文件
		...
		{#success}已完成文件
		{#warning}需要审查
	`)])),_:1,__:[0]})]),_:1}),t[5]||(t[5]=n()),t[6]||(t[6]=l("hr",null,null,-1)),t[7]||(t[7]=n()),e(i,null,{default:a(()=>[e(o,null,{default:a(()=>t[1]||(t[1]=[n(`
// 定义样式变量
#important=color:red;font-weight:bold;background:#ffe6e6;padding:2px 6px;border-radius:3px;
#success=color:green;font-weight:bold;background:#e6ffe6;padding:2px 6px;border-radius:3px;
#warning=color:orange;background:#fff3e0;padding:2px 6px;border-radius:3px;
...
`)])),_:1,__:[1]})]),_:1}),t[8]||(t[8]=n()),t[9]||(t[9]=l("hr",null,null,-1)),t[10]||(t[10]=n()),e(i,null,{default:a(()=>[e(o,null,{default:a(()=>t[2]||(t[2]=[n(`
	// 样式定义
